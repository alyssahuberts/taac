...
# Walkthrough should be focused on the survey
  ...
  walkthrough_incumbents$taac_survey_subcounty[walkthrough_incumbents$incumbents_scounty=="BULEGENI"] <- "Bulegeni"
  walkthrough_incumbents$taac_survey_subcounty[walkthrough_incumbents$incumbents_scounty=="NAMISUNI"] <- "Namisuni"
  ...
  walkthrough_incumbents$taac_survey_subcounty[walkthrough_incumbents$incumbents_scounty=="SIMU"] <- "Simu"
  walkthrough_incumbents$taac_survey_subcounty[walkthrough_incumbents$incumbents_scounty=="SISIYI"] <- "Sisiyi"
